...
public class Main {
            ...
            try {
                ...
                for (int y = 0; y < height; y++) {
                    for (int x = 0; x < width; x++) {
                        ...
                        if (MaskImageR >= 230 && MaskImageG >= 230 && MaskImageB >= 230)
    ...
    public static void main(String[] args) throws IOException {
        ...
        initializeAra();
        readImages(new File("C:\\Users\\Asus\\Desktop\\ibtd-20200115T095110Z-001\\ibtd\\NonMask\\"), new File("C:\\Users\\Asus\\Desktop\\ibtd-20200115T095110Z-001\\ibtd\\Mask\\"));
        calculateProbability();
        System.out.println("Finished training process");

        File testNonMaskImage = new File("C:\\Users\\Asus\\Desktop\\ibtd-20200115T095110Z-001\\ibtd\\tmpnonmask\\");
        ...
        try {
            for (int i = 0; i < testNonMaskImage.length(); i++) {
                ...
                testImage(testNonMaskImageFilePath[i], new File("C:\\Users\\Asus\\Desktop\\ibtd-20200115T095110Z-001\\ibtd\\tmpmask\\" + testNonMaskImageFilePath[i].getName()));
            }
        }catch (Exception e)
        {
        ...
        float accurecy = calculateAccurecy(new File("C:\\Users\\Asus\\Desktop\\ibtd-20200115T095110Z-001\\ibtd\\tmpmask\\"), new File("C:\\Users\\Asus\\Desktop\\ibtd-20200115T095110Z-001\\ibtd\\tmpnonmask\\")) + A;
